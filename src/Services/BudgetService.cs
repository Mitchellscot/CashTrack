...
namespace CashTrack.Services.BudgetService
{
    ...
    public class BudgetService : IBudgetService
    {
        ...
        internal List<ExpenseDataset> GetMonthlyExpenseData(BudgetEntity[] budgets, bool incomeExists, bool savingsExists, bool unallocatedExists, string[] mainCategoryLabels)
        {
