...
namespace CashTrack.Data
{
    ...
    public class AppContextFactory : IDesignTimeDbContextFactory<AppDbContext>
    {
        public AppDbContext CreateDbContext(string[] args)
        {
            ...
            var connectionString = env.Equals(CashTrackEnv.Production, StringComparison.InvariantCultureIgnoreCase) || env.Equals(CashTrackEnv.Electron, StringComparison.InvariantCultureIgnoreCase) ? $"Data Source={Path.Join(Directory.GetCurrentDirectory(), settings.ConnectionStrings[env])}" : $"Data Source={Path.Join(Directory.GetCurrentDirectory(), "Data", settings.ConnectionStrings[env])}";
